...
export const CONTENT_SOURCES: ContentSource[] = [
  ...
  {
    id: 'dgt-distracciones-al-conducir',
    name: 'DGT — Distracciones al conducir',
    description: 'Estadística (>30% de accidentes), configuración del navegador antes de circular, comer/beber/fumar al volante, recomendaciones sobre pasajeros, y el dato de distancia de frenado marcando un número (28 m frente a 155 m a 100 km/h).',
  ...
  {
    id: 'dgt-permiso-mayores-65',
    name: 'DGT — Permiso de conducir para mayores de 65 años',
    description: 'Vigencia del permiso según la edad (10 años con carácter general, 5 años a partir de los 65, 3 años para permisos profesionales), y confirmación de que no existe edad máxima para conducir en España.',
  ...
  {
    id: 'dgt-revista-paneles-complementarios',
    name: 'DGT (revista) — Paneles complementarios',
    description: 'Reportaje oficial de la revista de la DGT sobre el alcance real de las señales: qué son los paneles complementarios (distancia, longitud, restricción por dirección/carril/vehículo).',
    url: 'https://revista.dgt.es/es/reportajes/2013/donde-llega-aplicacion-sennal.shtml',
    owner: 'Dirección General de Tráfico (Ministerio del Interior) — revista oficial',
    license: '© DGT — contenido editorial institucional',
    contentType: 'Reportaje oficial',
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y explicaciones propias (derived) sobre el concepto y función de los paneles complementarios, citando la fuente'],
    cannotReuse: ['Copiar texto literal del reportaje como si fuera nuestro'],
    consultedAt: '2026-09-01',
    notes: 'El código S-810 (longitud del tramo) se corroboró además contra el Anexo de Wikipedia de señales de indicación, ya usado como referencia secundaria en signs.ts para códigos de señal.',
  },
  {
    id: 'dgt-en-tractor',
    name: 'DGT — En tractor y vehículo agrícola',
    description: 'Definición de vehículo especial agrícola, velocidades máximas por tipo (25/40/70 km/h), permiso de conducir requerido, señalización obligatoria (V-2, V-4, V-6) y restricción de acceso a autopistas/autovías.',
  ...
  {
    id: 'dgt-revista-remolques',
    name: 'DGT (revista) — Viajar con remolque',
    description: 'Clasificación por MMA (ligero ≤750 kg vs. no ligero), velocidad máxima en cada tipo de vía, y permisos/autorizaciones necesarios según el peso del remolque y del conjunto (B, B-96, B+E). El límite de velocidad (90 km/h en autopista/autovía) se contrastó además con RACE: es el mismo para remolque ligero y pesado, corrigiendo un resumen agregado que daba 80 km/h para el pesado sin respaldo de ninguna fuente primaria.',
  ...
  {
    id: 'dgt-planificar-viaje-seguro',
    name: 'DGT — Cómo planificar un viaje seguro por carretera',
    description: 'Revisiones del vehículo antes de un viaje largo (aceite, refrigerante, frenos, neumáticos, luces), planificación por etapas, condiciones climáticas en puertos de montaña, y consejos sobre comidas antes de conducir.',
  ...
  {
    id: 'dgt-glorietas-6-situaciones',
    name: 'DGT — Glorietas: cómo actuar en 6 situaciones habituales',
    description: 'Seis situaciones oficiales de circulación en glorietas: salida por el carril exterior (regla general), excepción de salida desde carril interior con flecha en el suelo, entrada por la izquierda cuando el derecho está saturado, prioridad de grupos de ciclistas, y precaución con vehículos grandes.',
    url: 'https://www.dgt.es/comunicacion/noticias/glorietas-como-actuar-en-6-situaciones-habituales/',
    owner: 'Dirección General de Tráfico (Ministerio del Interior)',
    license: 'unknown (contenido institucional público; sin licencia de reutilización explícita)',
    contentType: 'Normativa e información oficial',
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y diagramas propios (derived) basados en estas 6 situaciones, citando la fuente'],
    cannotReuse: ['Copiar o adaptar visualmente cualquier imagen o texto literal del artículo'],
    consultedAt: '2026-09-02',
  },
  {
    id: 'dgt-revista-intermitentes',
    name: 'DGT (revista) — Intermitentes: siempre imprescindibles (y obligatorios)',
    description: 'El intermitente como "declaración de intenciones": nunca otorga prioridad por sí solo (salvo la excepción de dos vehículos en el mismo carril señalizando un adelantamiento), y la técnica RSM (Retrovisor-Señalizar-Maniobra).',
    url: 'https://revista.dgt.es/es/educacion-formacion/conducir-mejor/2022/1202-CM-Intermitentes.shtml',
    owner: 'Dirección General de Tráfico (Ministerio del Interior) — revista oficial',
    license: '© DGT — contenido editorial institucional',
    contentType: 'Reportaje oficial',
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y diagramas propios (derived) basados en este hecho, citando la fuente'],
    cannotReuse: ['Copiar texto literal del reportaje como si fuera nuestro'],
    consultedAt: '2026-09-02',
  },
  {
    id: 'dgt-revista-vehiculos-prioritarios',
    name: 'DGT (revista) — Vehículos prioritarios: cómo actuar',
    description: 'Comportamiento correcto ante un vehículo de emergencias: reducir la velocidad progresivamente sin frenazos, apartarse hacia un lado, y qué hacer si sorprende dentro de un cruce (no bloquearlo, sin maniobras bruscas) o dentro de una glorieta (ceder sin cortar su trayectoria, salir por el carril exterior).',
    url: 'https://revista.dgt.es/es/educacion-formacion/conducir-mejor/2017/1207-Vehiculos-Prioritarios.shtml',
    owner: 'Dirección General de Tráfico (Ministerio del Interior) — revista oficial',
    license: '© DGT — contenido editorial institucional',
    contentType: 'Reportaje oficial',
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y diagramas propios (derived) basados en estas recomendaciones, citando la fuente'],
    cannotReuse: ['Copiar o adaptar visualmente cualquier imagen o texto literal del artículo'],
    consultedAt: '2026-09-02',
  },
  {
