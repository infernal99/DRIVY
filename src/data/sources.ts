...
export const CONTENT_SOURCES: ContentSource[] = [
  ...
  {
    id: 'dgt-en-patinete',
    name: 'DGT — En patinete',
    description: 'Normas oficiales para VMP (vehículos de movilidad personal): dónde pueden y no pueden circular, velocidad máxima, prohibición de alcohol/móvil/auriculares, y el estado (municipal, no nacional) de la obligación del casco.',
    ...
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y explicaciones propias (derived) basadas en estos hechos, citando la fuente'],
    cannotReuse: ['Copiar texto literal de la página como si fuera nuestro', 'Afirmar una edad mínima nacional o una obligación de casco en toda España: la propia página no lo especifica, depende de ordenanza municipal'],
    consultedAt: '2026-09-01',
  },
  {
    id: 'boe-rd-52-2026-vmp',
    name: 'BOE — Real Decreto 52/2026, Registro de Vehículos Personales Ligeros',
    description: 'Real Decreto 52/2026, de 28 de enero (BOE-A-2026-2140), que modifica el Reglamento General de Vehículos para regular el Registro de Vehículos Personales Ligeros y el seguro obligatorio de los VMP, desarrollando la Ley 5/2025, de 24 de julio.',
    url: 'https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-2140',
    owner: 'Boletín Oficial del Estado / Ministerio del Interior',
    license: 'Texto normativo público (BOE) — reutilizable para citar y referenciar',
    contentType: 'Norma jurídica (texto legal)',
    reviewStatus: 'cleared',
    canReuse: ['Citar el ámbito de aplicación, fechas de entrada en vigor y régimen transitorio para preguntas `derived` sobre VMP'],
    cannotReuse: ['Reproducir el texto legal completo como contenido propio'],
    consultedAt: '2026-09-01',
    notes:
      'En vigor desde el 30-01-2026 (mismo día de publicación). Ámbito: todos los VMP (1+ ruedas, plaza única, motor eléctrico exclusivo, 6-25 km/h si pesan <25kg o 6-14 km/h si pesan ≥25kg), excluyendo vehículos militares, dispositivos para personas con discapacidad y bicicletas de pedaleo asistido (EPAC). El seguro obligatorio es un requisito inmediato por la Ley 5/2025. Los VMP no certificados comercializados antes del 22-01-2024 pueden seguir circulando hasta el 22-01-2027 (disposición transitoria primera). Una nota de prensa previa de la propia DGT (2025-12-23) reflejaba un estado transitorio de incertidumbre/retraso sobre estas fechas — superado por la publicación final del RD, que es la fuente que prevalece.',
  },
  {
    id: 'dgt-con-ninos',
    name: 'DGT — Con niños',
    description: 'Sistemas de retención infantil (SRI): umbral de 135 cm, grupos clásicos por peso vs. i-Size/R129 por altura, asiento trasero y sus excepciones, desconexión del airbag frontal con sillas a contramarcha, y datos de reducción de mortalidad/lesiones.',
    url: 'https://www.dgt.es/muevete-con-seguridad/viaja-seguro/con-ninos/',
    owner: 'Dirección General de Tráfico (Ministerio del Interior)',
    license: 'unknown (contenido institucional público; sin licencia de reutilización explícita)',
    contentType: 'Normativa e información oficial',
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y explicaciones propias (derived) basadas en estos hechos, citando la fuente y el artículo 117 del RGC'],
    cannotReuse: [
  ...
  {
    id: 'dgt-hielo-nieve',
    name: 'DGT — Hielo y nieve: con la adherencia al límite',
    description: 'Zonas de mayor riesgo de hielo (umbrías, puentes), qué hacer si se pierde adherencia (no frenar), y comparativa de distancia de frenada en nieve entre neumáticos de invierno y de verano.',
    url: 'https://www.dgt.es/comunicacion/noticias/hielo-y-nieve-con-la-adherencia-al-limite/',
    owner: 'Dirección General de Tráfico (Ministerio del Interior)',
    license: 'unknown (contenido institucional público; sin licencia de reutilización explícita)',
    contentType: 'Nota de prensa / artículo informativo oficial',
    reviewStatus: 'cleared',
    canReuse: ['Redactar preguntas y explicaciones propias (derived) basadas en estos hechos, citando la fuente'],
    cannotReuse: ['Copiar texto literal del artículo como si fuera nuestro'],
    consultedAt: '2026-09-01',
  },
  {
    id: 'dgt-viento-fuerte',
    name: 'DGT — Conducir con el viento en contra',
    description: 'El "efecto pantalla" al adelantar vehículos grandes, zonas de mayor riesgo (puentes, viaductos, salidas de túnel) y vehículos más vulnerables al viento lateral (baca, remolque, carrocería angulosa).',
  ...
  {
    id: 'dgt-conducir-de-noche',
    name: 'DGT — Consejos para conducir de noche',
    description: 'Deslumbramiento (tiempo de recuperación de la visión, qué hacer), adaptación de la velocidad al alcance del alumbrado propio, y estadística de accidentes/fallecidos nocturnos.',
  ...
  {
    id: 'dgt-distintivo-ambiental',
    name: 'DGT — Distintivo ambiental',
    description: 'Clasificación de los distintivos ambientales (0, ECO, C, B): qué vehículos recibe cada uno, y su uso para regular zonas de bajas emisiones (ZBE) y restricciones por contaminación.',
  ...
  {
    id: 'dgt-adas',
    name: 'DGT — Sistemas avanzados de ayuda a la conducción (ADAS)',
    description: 'Qué son los ADAS y lista de los 8 sistemas obligatorios en vehículos de nueva homologación desde julio de 2022 (ISA, DDR, RCTA, EDR, LDW, ESS, inhibidor de arranque con alcoholímetro, alerta de cinturón).',
  ...
  {
    id: 'boe-reglamento-general-vehiculos',
    name: 'BOE — Reglamento General de Vehículos (RD 2822/1998)',
    description: 'Normativa técnica de vehículos, incluida (junto con el manual de inspección ITV) la exigencia de transparencia mínima en el parabrisas y las lunas delanteras.',
    url: 'https://www.boe.es/buscar/act.php?id=BOE-A-1999-1826',
    owner: 'Boletín Oficial del Estado / Ministerio del Interior',
    license: 'Texto normativo público (BOE) — reutilizable para citar y referenciar',
    contentType: 'Norma jurídica (texto legal)',
    reviewStatus: 'cleared',
    canReuse: ['Citar la exigencia de visibilidad mínima en lunas delanteras para preguntas `derived`'],
    cannotReuse: ['Reproducir el texto legal completo como contenido propio'],
    consultedAt: '2026-09-01',
    notes:
      'No se localizó un número de artículo único y preciso para la transparencia mínima de las lunas delanteras (el art. 16 RGV regula alumbrado, no cristales) — la cifra del 70% circula de forma consistente en múltiples fuentes profesionales del sector (talleres, ITV) que citan este RD junto con el reglamento ECE 43R y el manual de inspección ITV como base conjunta, así que se cita esa base normativa general en vez de un artículo concreto no confirmado.',
  },
  {
    id: 'boe-ley-trafico-rdl-6-2015',
    name: 'BOE — Texto refundido de la Ley de Tráfico (RDL 6/2015)',
    description: 'Ley de Tráfico, Circulación de Vehículos a Motor y Seguridad Vial. Usada para la clasificación de infracciones (art. 76, graves) y los supuestos de inmovilización del vehículo por agentes (art. 104).',
    url: 'https://www.boe.es/buscar/act.php?id=BOE-A-2015-11722',
    owner: 'Boletín Oficial del Estado / Ministerio del Interior',
    license: 'Texto normativo público (BOE) — reutilizable para citar y referenciar',
    contentType: 'Norma jurídica (texto legal)',
    reviewStatus: 'cleared',
    canReuse: ['Citar artículos y supuestos concretos (infracciones, inmovilización) para preguntas `derived`'],
    cannotReuse: ['Reproducir el texto legal completo como contenido propio'],
    consultedAt: '2026-09-01',
  },
  {
    id: 'practicatest-temario-indice',
    name: 'PracticaTest — índice de temas del permiso B (solo títulos, no contenido)',
    description:
      'Índice de los 38 temas del temario del permiso B de un test público de terceros, consultado ÚNICAMENTE para detectar huecos de cobertura temática (títulos de tema, no preguntas ni respuestas). Nunca usado como fuente de contenido: cada hueco detectado se investigó y fundamentó después contra DGT/BOE, no contra este sitio.',
    url: 'https://practicatest.com/temario/permiso-B',
    owner: 'PracticaTest (sitio de terceros)',
    license: 'Contenido de terceros — no copiado, solo se consultaron los títulos de sus 38 temas para planificación interna',
    contentType: 'Índice temático (referencia externa)',
    reviewStatus: 'reference_only',
    canReuse: ['Detectar qué áreas temáticas del permiso B podrían faltar en nuestro banco (p. ej. distintivo ambiental, carga, visibilidad, ADAS, inmovilización)'],
    cannotReuse: [
